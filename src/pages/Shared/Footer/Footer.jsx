  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-0 text-white">
        <div className="flex justify-end bg-[#1F2937] p-10">
          <div className="pr-10 text-center space-y-4">
        ...
        <div className="flex justify-start bg-[#111827] p-10">
          <div className="text-center pl-10 space-y-4">
